...
class VWidgetsPagePadding extends EdgeInsets {
  ...
  const VWidgetsPagePadding.horizontalSymmetric(double val) : super.symmetric(horizontal: val);
  const VWidgetsPagePadding.verticalSymmetric(double val) : super.symmetric(vertical: val);
  const VWidgetsPagePadding.only(double rVal, double lVal, double tVal) : super.only(right: rVal, left: lVal, top: tVal);
