...
class DiscoverUserSearchMainView extends StatefulWidget {
  const DiscoverUserSearchMainView({super.key});

  @override
  State<DiscoverUserSearchMainView> createState() =>
      _DiscoverUserSearchMainViewState();
}

class _DiscoverUserSearchMainViewState
    extends State<DiscoverUserSearchMainView> {
  @override
  void initState() {
    super.initState();
    checkStorageData();
