              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  Text("Congratulations!", style: Theme.of(context).textTheme.displayMedium!
                    ...
                    Text("Your booking with Sarah Tierney is \nscheduled for Sunday, September 4, \n14:00",
                      style: Theme.of(context).textTheme.displayMedium!
                        .copyWith(fontSize: 17, fontWeight: FontWeight.w500, color: VmodelColors.appBarBackgroundColor
                    ),),
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Text("Done", style: Theme.of(context).textTheme.displayMedium!
                              .copyWith(fontSize: 14, fontWeight: FontWeight.w700, color: VmodelColors.greyDeepText
                          ),),
                        ),
                      ),
                    )
