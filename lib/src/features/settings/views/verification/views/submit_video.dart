...
class SubmitVideo extends StatefulWidget {
  const SubmitVideo({Key? key, required this.videoFile}) : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children:  [
              ...
              Text("Great! Check your video is easy to see and hear before you press send.",
              ...
              VWidgetsPrimaryButton(onPressed: (){
                ...
                buttonTitle: "Submit video", enableButton: true,),
