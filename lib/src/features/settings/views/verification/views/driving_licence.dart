...
class _UploadIdentityDocumentState extends State<UploadIdentityDocument> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: controller?.value != null ? !controller!.value.isInitialized ? Container() :
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children:  [
              ...
              Text("Make sure the front of your driving licence is in the frame.",
              ...
              GestureDetector(
                onTap: ()async{
                  ...
                  navigateToRoute(context, CapturedDrivingLicence(image: pictureFile!));
                },
                child: Container(
                  height: 60,
                  width: 60,
