...
class CapturedDrivingLicence extends StatefulWidget {
  const CapturedDrivingLicence({Key? key, required this.image}) : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children:  [
              ...
              Text("Is the front of your driving licence in the frame and easy to read? If so, you’re good to go!",
              ...
              VWidgetsPrimaryButton(onPressed: (){
                navigateToRoute(context, const VerifyVideo());
              },
              buttonTitle: "Use this picture", enableButton: true,),
