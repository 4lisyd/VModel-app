...
class ResetVerificationCodePage extends StatefulWidget {
  ...
  const ResetVerificationCodePage({super.key, required this.otp, required this.link});
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        Text(
            ...
            addVerticalSpacing(40),
            Text(_err, style: Theme.of(context).textTheme.displayMedium!.copyWith(
              fontWeight: FontWeight.w500,
            ...
            VWidgetsPrimaryButton(
                ...
                enableButton: true,
                onPressed: () {
                  if(_otpController.text.trim().toLowerCase() == widget.otp.toLowerCase()){
                    navigateToRoute(context, CreatePasswordView(link: widget.link));
                  } else {
                    setState(() {
                      _err = 'Incorrect OTP';
                    });
