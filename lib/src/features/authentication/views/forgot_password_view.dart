...
class ForgotPasswordView extends ConsumerStatefulWidget with ValidationsMixin {
                      ...
                      onPressed: () async {
                        ...
                        if(_formKey.currentState!.validate() == false){
                          ...
                          if(authNotifier.state.status == AuthStatus.authenticated){
                            progress?.dismiss();
                            if(mounted) {
                              navigateToRoute(context, ResetVerificationCodePage(otp: authNotifier.state.otp.toString(), link: authNotifier.state.token.toString()));
