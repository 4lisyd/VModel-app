...
class CreatePasswordView extends ConsumerStatefulWidget with ValidationsMixin {
  final String? link;
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
                  ...
                  child: Form(
                    ...
                    child: Column(
                      children: [
                        ...
                        vmSizedH(SizeConfig.screenHeight * 0.028),
                        VWidgetsSignUpTextField(
                          onSaved: (String? value) {},
                          hintText: '',
            ...
            onPressed: () async{
              ...
              if(controller1.text.trim() == controller2.text.trim()) {
                ...
                await authNotifier.resetPassword(
                    token: widget.link.toString(), newPassword1: controller1.text.trim(), newPassword2: controller2.text.trim());
          ...
          vmSizedH(SizeConfig.screenHeight * 0.07),
        ],
      ),
    );
  }
