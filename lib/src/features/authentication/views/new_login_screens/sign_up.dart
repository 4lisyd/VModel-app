                  ...
                  children: [
                    ...
                    VWidgetsLoginTextField(
                      ...
                      suffixIcon: IconButton(
                          ...
                          icon: Icon(
                            _isUserNameAvailable ? Icons.error : Icons.verified_rounded,
                          )),
                    ),
                    VWidgetsLoginTextField(
                      hintText: "Email",
                        ...
                        onPressed: () async{
                          ...
                          if(_formKey.currentState!.validate() == false){
                            ...
                            if (authNotifier.state.status == AuthStatus.authenticated ) {
                              await authNotifier.login(_email.text.trim(), _password1.text.trim());
                              progress?.dismiss();
                              if (mounted) {
                    ...
                    Column(
                      ...
                      children: [
                        Text("By Sign-in/Signing-up, you agree to Vmodel's",
                            style: Theme.of(context).textTheme.displaySmall!.copyWith(color: VmodelColors.primaryColor.withOpacity(0.5),)),
